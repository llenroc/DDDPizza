...
!function(r){var o=["orderRepository"],n=function(r){function o(){r.getOrders().then(function(r){n.orders=r})}var n=this;n.orders=[],o()};n.$inject=o,r.controller("viewController",n)}(angular.module("dddPizza"));
