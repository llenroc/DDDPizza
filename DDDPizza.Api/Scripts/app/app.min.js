...
!function(e){var r=["inventoryRepository","pizza","order","localStorage","toastr"],t=function(e,r,t,a,s){var i=this;i.userkey="orderToken",i.pizza=r,i.order=t,i.breads=[],i.tempOrder={},i.init=function(){e.getInventory().then(function(e){i.breads=e.breads,i.sauces=e.sauces,i.cheeses=e.cheeses,i.sizes=e.sizes,i.toppings=e.toppings}),null==a.get(i.userkey)&&a.add(i.userkey,i.order),i.tempOrder=a.get(i.userkey)},i.getOrderSubTotal=function(){for(var e=0,r=0;r<i.tempOrder.pizzas.length;r++){var t=i.tempOrder.pizzas[r];e+=t.total}return i.tempOrder.subtotal=e,e},i.getOrderTotal=function(){return i.tempOrder.total=null!=i.tempOrder.serviceCharge?parseFloat(i.tempOrder.subtotal)+parseFloat(i.tempOrder.serviceCharge):parseFloat(i.tempOrder.subtotal),i.tempOrder.total},i.updateServiceCharge=function(){i.tempOrder.serviceCharge=parseFloat("Delivery"===i.tempOrder.serviceType?2:0)},i.updateTotal=function(){i.pizza.total=0,isNaN(i.pizza.size.price)||(i.pizza.total=parseFloat(i.pizza.size.price)),i.pizza.topping.forEach(function(e){null!==e&&(isNaN(e.price)||null==e.price||(i.pizza.total+=parseFloat(e.price)))})},i.copyPizza=function(e){var r=a.get(i.userkey);r.pizzas.push(e),a.add(i.userkey,r),s.success("Successful!","Pizza was copied!"),i.init()},i.removePizza=function(e){var r=a.get(i.userkey);r.pizzas.splice(e,1),a.add(i.userkey,r),s.success("Successful!","Pizza was removed!"),i.init()},i.submitPizza=function(e){var r=a.get(i.userkey);r.pizzas.push(i.pizza),a.add(i.userkey,r),s.success("Successful!","Pizza was added to Order!"),i.init()},i.submitFinalOrder=function(){e.placeOrder(i.tempOrder).then(function(e){console.log(e)})["catch"](function(e){console.log(e)})}};t.$inject=r,e.controller("homeController",t)}(angular.module("dddPizza"));
...
!function(e){var r=["httpRepository","$q"],t=function(e,r){var t=function(){var t=r.defer();return e.getData("/api/orders").then(function(e){t.resolve(e)})["catch"](function(e){t.reject(e)}),t.promise};return{getOrders:t}};t.$inject=r,e.service("orderRepository",t)}(angular.module("dddPizza"));
