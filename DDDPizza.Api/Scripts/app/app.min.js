...
!function(e){var r=["httpRepository","$q"],t=function(e,r){var t=function(){var t=r.defer();return e.getData("/api/current/orders").then(function(e){t.resolve(e)})["catch"](function(e){t.reject(e)}),t.promise},n=function(){var t=r.defer();return e.getData("/api/past/orders").then(function(e){t.resolve(e)})["catch"](function(e){t.reject(e)}),t.promise},o=function(t){var n=r.defer();return e.getData("/api/orders/"+t).then(function(e){n.resolve(e)})["catch"](function(e){n.reject(e)}),n.promise},c=function(){var t=r.defer();return e.getData("/api/services").then(function(e){t.resolve(e)})["catch"](function(e){t.reject(e)}),t.promise};return{getOrders:t,getPastOrders:n,getOrderById:o,getServiceOptions:c}};t.$inject=r,e.service("orderRepository",t)}(angular.module("dddPizza"));
