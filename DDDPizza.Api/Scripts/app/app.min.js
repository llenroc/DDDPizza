...
!function(t){var e=["inventoryRepository","$stateParams"],i=function(t,e){var i=this;i.title=e.id.toUpperCase(),i.hasPrice=!1,i.items=[],i.init=function(){t.getInventoryByType(e.id).then(function(t){i.items=t,t[0].price>0&&(i.hasPrice=!0)})}};i.$inject=e,t.controller("inventoryController",i)}(angular.module("dddPizza"));
!function(n){var i=function(){var n=this;n.init=function(){}};n.controller("navigationController",i)}(angular.module("dddPizza"));
!function(e){var r=["$state","inventoryRepository","orderRepository","pizza","order","localStorage","toastr"],t=function(e,r,t,a,s,i,o){var n=this;n.userkey="orderToken",n.pizza=a,n.resetPizza=angular.copy(n.pizza),n.order=s,n.breads=[],n.services=[],n.tempOrder={},n.init=function(){n.pizza=n.resetPizza,r.getInventory().then(function(e){n.breads=e.breads,n.sauces=e.sauces,n.cheeses=e.cheeses,n.sizes=e.sizes,n.toppings=e.toppings}),t.getServiceOptions().then(function(e){n.services=e}),null==i.get(n.userkey)&&i.add(n.userkey,n.order),n.tempOrder=i.get(n.userkey)},n.getOrderSubTotal=function(){for(var e=0,r=0;r<n.tempOrder.pizzas.length;r++){var t=n.tempOrder.pizzas[r];e+=t.total}return n.tempOrder.subtotal=e,e},n.getOrderTotal=function(){return n.tempOrder.total=null!=n.tempOrder.serviceCharge?parseFloat(n.tempOrder.subtotal)+parseFloat(n.tempOrder.serviceCharge):parseFloat(n.tempOrder.subtotal),n.tempOrder.total},n.updateServiceCharge=function(){n.tempOrder.serviceCharge=parseFloat("Delivery"===n.tempOrder.serviceType?2:0)},n.updateTotal=function(){n.pizza.total=0,isNaN(n.pizza.size.price)||(n.pizza.total=parseFloat(n.pizza.size.price)),n.pizza.topping.forEach(function(e){null!==e&&(isNaN(e.price)||null==e.price||(n.pizza.total+=parseFloat(e.price)))})},n.copyPizza=function(e){var r=i.get(n.userkey);r.pizzas.push(e),i.add(n.userkey,r),o.success("Successful!","Pizza was copied!"),n.init()},n.removePizza=function(e){var r=i.get(n.userkey);r.pizzas.splice(e,1),i.add(n.userkey,r),o.success("Successful!","Pizza was removed!"),n.init()},n.submitPizza=function(){var e=i.get(n.userkey);e.pizzas.push(n.pizza),console.log(n.pizza),i.add(n.userkey,e),o.success("Successful!","Pizza was added to Order!"),n.init()},n.submitFinalOrder=function(){t.placeOrder(n.tempOrder).then(function(r){o.success("Successful!","Order has been placed on the queue!"),i.clear(),e.go("current",{},{reload:!0})})["catch"](function(e){o.error("Error!",e)})}};t.$inject=r,e.controller("orderController",t)}(angular.module("dddPizza"));
...
!function(e){var n=["httpRepository","$q"],t=function(e,n){var t=function(){var t=n.defer();return e.getData("/api/inventory").then(function(e){t.resolve(e)})["catch"](function(e){t.reject(e)}),t.promise},r=function(t){var r=n.defer();return e.getData("/api/inventory/"+t).then(function(e){r.resolve(e)})["catch"](function(e){r.reject(e)}),r.promise};return{getInventory:t,getInventoryByType:r}};t.$inject=n,e.service("inventoryRepository",t)}(angular.module("dddPizza"));
!function(n){var o=["$window"],t=function(n){var o=n.localStorage,t=function(n,t){t=angular.toJson(t),o.setItem(n,t)},a=function(n){var t=o.getItem(n);return t&&(t=angular.fromJson(t)),t},e=function(n){o.removeItem(n)},r=function(){o.clear()};return{add:t,get:a,remove:e,clear:r}};t.$inject=o,n.factory("localStorage",t)}(angular.module("dddPizza"));
...
!function(t){var n=function(){return{restrict:"AE",require:"^form",bindToController:!0,templateUrl:"/Scripts/app/directives/templates/dynamicDDL.html",controllerAs:"vm",scope:{amount:"@",passPizza:"=",updateAmount:"&"},controller:["inventoryRepository",function(t){var n=this;t.getInventory().then(function(t){n.toppings=t.toppings}),n.add=function(){n.amount++},n.remove=function(){n.amount--,delete n.passPizza.topping[n.amount],n.updateAmount()},n.range=function(t){for(var n=[],o=0;t>o;o++)n.push(o);return n}}]}};t.directive("dynamicdropdownlist",n)}(angular.module("dddPizza"));
