...
describe("viewController", function () {
    ...
    var scope, controller, mockOrderData;
    ...
    beforeEach(function () {
        ...
        mockOrderData = { getOrders: function() {
            return $q.when(getMockOrders());
        } };
        controller = $controller("viewController", { orderRepository: mockOrderData });
    });
